...
import com.apress.beginninggwt.gwtasks.client.manager.data.RemoteDataManager;
import com.apress.beginninggwt.gwtasks.client.manager.data.InMemoryDataManager;
import com.apress.beginninggwt.gwtasks.client.manager.security.RemoteSecurityManager;
...
public class GWTasks implements EntryPoint {
	...
	public void onModuleLoad() {
        ...
        SecurityManager securityManager = new RemoteSecurityManager();
        DataManager dataManager = new RemoteDataManager();
